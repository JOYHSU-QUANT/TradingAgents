...
- **長駐建議**同 paper（[RUNBOOK §3](./RUNBOOK.md)）：掛在會自動重啟的監管下，
  ...
  若是別的 process 鎖著它或底層儲存不穩，重跑會好；若是權限就不會。兩者都要看訊息
  引的那句底層錯誤才知道是哪一種。
