...
and ``live/``, :func:`optional_decimal` into ``live/`` alone (``signed_client``'s Decimal
wire fields are all required; its one optional parse, ``exchange_time``, is a
timestamp and hand-rolls the same discipline) — plus
