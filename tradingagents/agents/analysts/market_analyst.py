    ...
    def market_analyst_node(state):
        ...
        if asset_type == "crypto" and not is_category_disabled(
            ...
            crypto_tools_message = (
                ...
                "RR25 range and no RR25 percentile, and none can be inferred from a single "
                "print. State RR25's sign, magnitude and tenor; do NOT describe it as "
                "elevated, extreme, unusual, stretched or compressed. "
