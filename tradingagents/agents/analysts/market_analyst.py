...
def _futures_basis_message() -> str:
    ...
    return (
        ...
        "as the report does. CME closes for the weekend and this analysis does not: when the "
        "report says it is not a live reading, the figures are the last session's, so state "
        "their age and do not describe them as a response to anything since. "
