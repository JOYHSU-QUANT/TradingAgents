    ...
    def market_analyst_node(state):
        ...
        if asset_type == "crypto" and not is_category_disabled(
            ...
            crypto_tools_message = (
                ...
                "report prints. The report's Forward is Deribit's forward price for that "
                ...
                "and for an asset this vendor reads no chain for — in each case the report "
                "says so in place of the ATM/RR25 figures, and you must not substitute today's "
                "or BTC's skew for them; if the report is headed as a market-wide proxy the "
                "figures are BTC's, so treat them as a crypto-wide volatility signal and never "
